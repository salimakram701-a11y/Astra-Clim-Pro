...
createServer(async (request, response) => {
  ...
  console.log(`Astra Clim Pro démarré : http://localhost:${PORT} (stockage : ${database.kind === 'turso' ? 'Turso (persistant)' : 'fichier local (non persistant sur hébergeur sans disque)'})`);
